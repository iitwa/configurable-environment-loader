...
describe('Tests', () => {
    ...
    test('Optional parameter not specified with supplied message', async () => {
        ...
        let options: EnvironmentLoaderOptions = {
            ...
            expectedEnvironmentVariables: [
                {
                    variableName: "OptionalParm",
                    expectedType: valueIsString,
                    messageWhenMissing: "OptionalParm is missing",
                    isRequired: false
                }
            ],
            suppliedEnvironmentVariables: {}
        ...
        let expectedEnvironmentVariables = {
            ...
            "loadMessages":["OptionalParm is missing"]
        }
    ...
    test('Optional parameter not specified with default message', async () => {
        ...
        let expectedEnvironmentVariables = {
            ...
            "environmentVariables": {} ,
            "loadMessages":  [
             "Missing value for variable  OptionalParm but no default value provided",
            ],
            "loadedSuccessfully": true,
        }
